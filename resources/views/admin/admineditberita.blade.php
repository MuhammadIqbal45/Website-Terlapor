  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">Edit Layanan Berita</h3>
      ...
      <div class="box-body">
        <form action="{{ url('admin-update-berita', $edt->id) }}" method="post" >
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <label>Caption</label>
                <input name="caption" type="text" class="form-control" placeholder="Caption" value="{{ $edt -> caption }}">
              </div>
              <div class="form-group">
                <label>Uraian</label>
